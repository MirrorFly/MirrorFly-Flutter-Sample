...
class RecentChatData {
  ...
  factory RecentChatData.fromJson(Map<String, dynamic> json) => RecentChatData(
    ...
    lastMessageStatus: Platform.isAndroid ? json["lastMessageStatus"]["status"] : json["lastMessageStatus"] == "acknowledge" ? "A" : json["lastMessageStatus"] == "delivered" ? "D" : json["lastMessageStatus"] == "seen" ? "S" : json["lastMessageStatus"] == "received" ? "R" : "N",//"N" for "sent" in iOS,
