...
class FlyChat {
  ...
  //Event Channels
  static const EventChannel messageOnReceivedChannel =
      EventChannel('contus.mirrorfly/onMessageReceived');
  static const EventChannel messageStatusUpdatedChanel =
      EventChannel('contus.mirrorfly/onMessageStatusUpdated');
  static const EventChannel mediaStatusUpdatedChannel =
      EventChannel('contus.mirrorfly/onMediaStatusUpdated');
  static const EventChannel uploadDownloadProgressChangedChannel =
      EventChannel('contus.mirrorfly/onUploadDownloadProgressChanged');
  static const EventChannel showUpdateCancelNotificationChannel =
      EventChannel('contus.mirrorfly/showOrUpdateOrCancelNotification');

  static const EventChannel onGroupProfileFetchedChannel =
      EventChannel('contus.mirrorfly/onGroupProfileFetched');
  static const EventChannel onNewGroupCreatedChannel =
      EventChannel('contus.mirrorfly/onNewGroupCreated');
  static const EventChannel onGroupProfileUpdatedChannel =
      EventChannel('contus.mirrorfly/onGroupProfileUpdated');
  static const EventChannel onNewMemberAddedToGroupChannel =
      EventChannel('contus.mirrorfly/onNewMemberAddedToGroup');
  static const EventChannel onMemberRemovedFromGroupChannel =
      EventChannel('contus.mirrorfly/onMemberRemovedFromGroup');
  static const EventChannel onFetchingGroupMembersCompletedChannel =
      EventChannel('contus.mirrorfly/onFetchingGroupMembersCompleted');
  static const EventChannel onDeleteGroupChannel =
      EventChannel('contus.mirrorfly/onDeleteGroup');
  static const EventChannel onFetchingGroupListCompletedChannel =
      EventChannel('contus.mirrorfly/onFetchingGroupListCompleted');
  static const EventChannel onMemberMadeAsAdminChannel =
      EventChannel('contus.mirrorfly/onMemberMadeAsAdmin');
  static const EventChannel onMemberRemovedAsAdminChannel =
      EventChannel('contus.mirrorfly/onMemberRemovedAsAdmin');
  static const EventChannel onLeftFromGroupChannel =
      EventChannel('contus.mirrorfly/onLeftFromGroup');
  static const EventChannel onGroupNotificationMessageChannel =
      EventChannel('contus.mirrorfly/onGroupNotificationMessage');
  static const EventChannel onGroupDeletedLocallyChannel =
      EventChannel('contus.mirrorfly/onGroupDeletedLocally');

  static const EventChannel blockedThisUserChannel =
      EventChannel('contus.mirrorfly/blockedThisUser');
  static const EventChannel myProfileUpdatedChannel =
      EventChannel('contus.mirrorfly/myProfileUpdated');
  static const EventChannel onAdminBlockedOtherUserChannel =
      EventChannel('contus.mirrorfly/onAdminBlockedOtherUser');
  static const EventChannel onAdminBlockedUserChannel =
      EventChannel('contus.mirrorfly/onAdminBlockedUser');
  static const EventChannel onContactSyncCompleteChannel =
      EventChannel('contus.mirrorfly/onContactSyncComplete');
  static const EventChannel onLoggedOutChannel =
      EventChannel('contus.mirrorfly/onLoggedOut');
  static const EventChannel unblockedThisUserChannel =
      EventChannel('contus.mirrorfly/unblockedThisUser');
  static const EventChannel userBlockedMeChannel =
      EventChannel('contus.mirrorfly/userBlockedMe');
  static const EventChannel userCameOnlineChannel =
      EventChannel('contus.mirrorfly/userCameOnline');
  static const EventChannel userDeletedHisProfileChannel =
      EventChannel('contus.mirrorfly/userDeletedHisProfile');
  static const EventChannel userProfileFetchedChannel =
      EventChannel('contus.mirrorfly/userProfileFetched');
  static const EventChannel userUnBlockedMeChannel =
      EventChannel('contus.mirrorfly/userUnBlockedMe');
  static const EventChannel userUpdatedHisProfileChannel =
      EventChannel('contus.mirrorfly/userUpdatedHisProfile');
  static const EventChannel userWentOfflineChannel =
      EventChannel('contus.mirrorfly/userWentOffline');
  static const EventChannel usersIBlockedListFetchedChannel =
      EventChannel('contus.mirrorfly/usersIBlockedListFetched');
  static const EventChannel usersProfilesFetchedChannel =
      EventChannel('contus.mirrorfly/usersProfilesFetched');
  static const EventChannel usersWhoBlockedMeListFetchedChannel =
      EventChannel('contus.mirrorfly/usersWhoBlockedMeListFetched');
  static const EventChannel onConnectedChannel =
      EventChannel('contus.mirrorfly/onConnected');
  static const EventChannel onDisconnectedChannel =
      EventChannel('contus.mirrorfly/onDisconnected');
  static const EventChannel onConnectionNotAuthorizedChannel =
      EventChannel('contus.mirrorfly/onConnectionNotAuthorized');
  static const EventChannel connectionFailedChannel =
      EventChannel('contus.mirrorfly/connectionFailed');
  static const EventChannel connectionSuccessChannel =
      EventChannel('contus.mirrorfly/connectionSuccess');
  static const EventChannel onWebChatPasswordChangedChannel =
      EventChannel('contus.mirrorfly/onWebChatPasswordChanged');
  static const EventChannel setTypingStatusChannel =
      EventChannel('contus.mirrorfly/setTypingStatus');
  static const EventChannel onChatTypingStatusChannel =
      EventChannel('contus.mirrorfly/onChatTypingStatus');
  static const EventChannel onGroupTypingStatusChannel =
      EventChannel('contus.mirrorfly/onGroupTypingStatus');
  static const EventChannel onFailureChannel =
      EventChannel('contus.mirrorfly/onFailure');
  static const EventChannel onProgressChangedChannel =
      EventChannel('contus.mirrorfly/onProgressChanged');
  static const EventChannel onSuccessChannel =
      EventChannel('contus.mirrorfly/onSuccess');
  ...
  static Future<dynamic> getNUnreadMessagesOfEachUsers(
      int messagesCount) async {
    dynamic res;
    try {
      res = await mirrorFlyMethodChannel.invokeMethod(
  ...
  static Future<dynamic> getUsersListToAddMembersInOldGroup(
      String groupJid) async {
    dynamic res;
    try {
      res = await mirrorFlyMethodChannel.invokeMethod(
  ...
  static Future<dynamic> getJid(String username) async {
    //getuserjid
    dynamic userJID;
    try {
  ...
  static Future<dynamic> sendLocationMessage(String jid, double latitude,
  ...
  static Future<dynamic> getRegisteredUserList({required bool server}) async {
  ...
  static Future<dynamic> getUserList(int page, String search,
  ...
  static Future<dynamic> getRecentChatList() async {
    //getRecentChats
  ...
  static Future<dynamic> getProfileStatusList() async {
    //getStatusList
  ...
  static Future<dynamic> updateMyProfile(String name, String email,
  ...
  static Future<dynamic> getUserProfile(String jid,
  ...
  static Future<dynamic> updateMyProfileImage(String image) async {
    //updateProfileImage
    dynamic profileResponse;
    try {
      profileResponse = await mirrorFlyMethodChannel
  ...
  static Future<dynamic> getMessagesOfJid(String jid) async {
    //getChatHistory
  ...
  static Future<dynamic> markAsReadDeleteUnreadSeparator(String jid) async {
    //sendReadReceipts
  ...
  static Future<dynamic> logoutOfChatSDK() async {
    //logout
  ...
  static setOnGoingChatUser(String jid) async {
    //ongoingChat
    try {
      await mirrorFlyMethodChannel
  ...
  static downloadMedia(String mid) async {
    //mediaDownload
    try {
      await mirrorFlyMethodChannel
  ...
  static Future<dynamic> getRecentChatListIncludingArchived() async {
  ...
  static Future<bool?> unblockUser(String userJID) async {
    //unBlockUser
  ...
  static Future<bool?> addUsersToGroup(
      String jid, List<String> userList) async {
    bool? response;
    try {
  ...
  static Future<dynamic> getGroupMembersList(String jid, bool? server) async {
    //getGroupMembers
    dynamic response;
    try {
      response =
  ...
  static Future<bool?> removeMemberFromGroup(
      String groupjid, String userjid) async {
    bool? response;
    try {
      response = await mirrorFlyMethodChannel.invokeMethod<bool>(
  ...
  static Future<bool?> sendContactUsInfo(
