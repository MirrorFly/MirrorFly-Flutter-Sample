...
#ifndef FLYCALL_SWIFT_H
#define FLYCALL_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="FlyCall",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
# pragma pop_macro("any")
#endif

#if defined(__OBJC__)

SWIFT_CLASS("_TtC7FlyCall14CallLogManager")
...
SWIFT_CLASS("_TtC7FlyCall11CallManager")
...
@interface CallManager (SWIFT_EXTENSION(FlyCall))
+ (BOOL)isOngoingCall SWIFT_WARN_UNUSED_RESULT;
+ (BOOL)checkForActiveCall SWIFT_WARN_UNUSED_RESULT;
@end


SWIFT_CLASS("_TtC7FlyCall22CallParticipantsStatus")
@interface CallParticipantsStatus : NSObject
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end


SWIFT_CLASS("_TtC7FlyCall11CallPayload")
@interface CallPayload : NSObject
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end


SWIFT_CLASS("_TtC7FlyCall17FlyCallController")
@interface FlyCallController : NSObject
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end



SWIFT_CLASS("_TtC7FlyCall12FlyCallUtils")
...
/// import FlyDatabase
SWIFT_CLASS("_TtC7FlyCall28NotificationExtensionSupport")
...
SWIFT_CLASS("_TtC7FlyCall20PeerConnectionClient")
...
@interface PeerConnectionClient (SWIFT_EXTENSION(FlyCall)) <RTCPeerConnectionDelegate>
...
SWIFT_CLASS("_TtC7FlyCall12RealmCallLog")
@interface RealmCallLog : RealmSwiftObject
/// This variable is used  to store the CallLogID
@property (nonatomic, copy) NSString * _Nullable callId;
/// This varaible is used to store the from user JID
@property (nonatomic, copy) NSString * _Nullable fromUser;
/// This varaible is used to store the to user JID
@property (nonatomic, copy) NSString * _Nullable toUser;
/// This variable is used to store the caller’s device
@property (nonatomic, copy) NSString * _Nullable callerDevice;
/// This varaible is used to store the type of call video or audio
@property (nonatomic, copy) NSString * _Nullable callType;
/// This varaible is used to store the time when the call log is saved
@property (nonatomic) double callTime;
/// This varaible is used to store the start time is saved
@property (nonatomic) double startTime;
/// This varaible is used to store the end time is saved
@property (nonatomic) double endTime;
/// This varaible is used to store the type of call
@property (nonatomic, copy) NSString * _Nullable callState;
@property (nonatomic, copy) NSString * _Nullable callMode;
@property (nonatomic, copy) NSString * _Nullable userList;
@property (nonatomic, copy) NSString * _Nullable sessionStatus;
@property (nonatomic, copy) NSString * _Nullable groupId;
@property (nonatomic, copy) NSString * _Nonnull customData;
@property (nonatomic) BOOL isLogSync;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end



SWIFT_CLASS("_TtC7FlyCall11VOIPManager")
...
SWIFT_PROTOCOL("_TtP7FlyCall10ikDelegate_")
@protocol ikDelegate
@end
