...
class MessageTypingAreaStyle {
  const MessageTypingAreaStyle({
    ...
    this.mentionTextStyle = const TextStyle(
        color: Colors.blueAccent, backgroundColor: Colors.transparent),
    ...
    this.mentionUserBgDecoration = const BoxDecoration(
      color: Colors.white,
      border: Border(
        left: BorderSide(color: Color(0xffC1C1C1)),
        right: BorderSide(color: Color(0xffC1C1C1)),
        top: BorderSide(color: Color(0xffC1C1C1)),
      ),
      borderRadius: BorderRadius.only(
...
class NotificationMessageViewStyle {
  const NotificationMessageViewStyle({
    this.decoration = const BoxDecoration(
        color: Color(0xffDADADA),
        borderRadius: BorderRadius.all(Radius.circular(15))),
    this.textStyle = const TextStyle(
        fontWeight: FontWeight.w500, color: Color(0xff565656), fontSize: 13),
  });
...
class TextMessageViewStyle {
  const TextMessageViewStyle({
    ...
    this.mentionUserColor = const Color(0xff4879F9),
    this.mentionedMeBgColor = const Color(0XffD2E3FC),
    this.scheduleTextStyle = const TextStyle(
        fontSize: 13,
...
class DownloadUploadViewStyle {
  const DownloadUploadViewStyle(
      ...
      this.progressIndicatorThemeData = const ProgressIndicatorThemeData(
