...
class ProfileViewStyle{
  ...
  const ProfileViewStyle({
    ...
    this.nameTextFieldStyle = const EditTextFieldStyle(titleStyle: TextStyle(fontWeight: FontWeight.normal,color: Color(0xff181818)),editTextHintStyle: TextStyle(fontWeight: FontWeight.normal,color: Color(0xff959595),fontSize: 16),editTextStyle: TextStyle(fontWeight: FontWeight.w600,color: Colors.black,fontSize: 16)),
    this.emailTextFieldStyle = const EditTextFieldStyle(titleStyle: TextStyle(fontWeight: FontWeight.normal,color: Color(0xff181818)),editTextHintStyle: TextStyle(fontWeight: FontWeight.normal,color: Color(0xff959595),fontSize: 13),editTextStyle: TextStyle(fontWeight: FontWeight.normal,color: Color(0xff767676),fontSize: 13)),
