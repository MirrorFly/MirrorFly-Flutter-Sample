...
class OngoingCallPageStyle{
  ...
  const OngoingCallPageStyle({
    ...
    this.pinnedCallUserTileStyle = const CallUserTileStyle(profileImageSize: 100,backgroundColor: Colors.transparent),
    this.listCallUserTileStyle = const CallUserTileStyle(profileImageSize: 50),
