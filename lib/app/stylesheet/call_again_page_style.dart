...
class CallAgainPageStyle{
  ...
  const CallAgainPageStyle({
    ...
    this.bottomActionsContainerDecoration = const BoxDecoration(color: Color(0xff162337)),
    this.bottomActionsContainerTextStyle = const TextStyle(fontWeight: FontWeight.w300,color: Colors.white,fontSize: 14),
    this.cancelActionStyle = const ActionButtonStyle(activeIconColor: Color(0xff303030),activeBgColor: Colors.white),
    this.callAgainActionStyle = const ActionButtonStyle(activeIconColor: Colors.white,activeBgColor: Color(0xff2FC076)),
    this.actionsTitleStyle = const TextStyle(fontWeight: FontWeight.w300,color: Colors.white,fontSize: 12),
  });
}