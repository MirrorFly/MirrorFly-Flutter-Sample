...
class LoginPageStyle {
  ...
  const LoginPageStyle({
    ...
    this.appBarTextStyle = const TextStyle(
        fontWeight: FontWeight.w700, color: Color(0xff181818), fontSize: 20),
    // Style for the body title text
    this.bodyTitleStyle = const TextStyle(
        fontWeight: FontWeight.w500, color: Color(0xff181818), fontSize: 15),
    // Style for the body description text
    this.bodyDescriptionStyle = const TextStyle(
        fontWeight: FontWeight.w300, color: Color(0xff767676), fontSize: 14),
    // Style for the selected country text
    this.selectedCountryTextStyle = const TextStyle(
        fontWeight: FontWeight.normal, color: Color(0xff181818), fontSize: 15),
    // Style for the selected country code text
    this.selectedCountryCodeTextStyle = const TextStyle(
        fontWeight: FontWeight.normal, color: Color(0xff181818), fontSize: 15),
    // Style for the edit text field
    this.editTextFieldStyle = const EditTextFieldStyle(
    ...
    this.footerHeadlineStyle = const TextStyle(
        fontWeight: FontWeight.w300, color: Color(0xff767676), fontSize: 11),
    // Style for the terms text
    this.termsTextStyle = const TextStyle(
        fontWeight: FontWeight.normal,
