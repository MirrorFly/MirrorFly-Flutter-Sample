...
class JoinCallPreviewPageStyle{
  ...
  const JoinCallPreviewPageStyle({
    this.appBarTheme = const AppBarTheme(backgroundColor: Colors.transparent,
      iconTheme: IconThemeData(color: Colors.white),
      actionsIconTheme: IconThemeData(color: Colors.white),),
    this.callLinkErrorViewStyle = const CallLinkErrorViewStyle(callEndedTextStyle: TextStyle(fontWeight: FontWeight.w500,color: Colors.white, fontSize: 15),
    callEndedMessageTextStyle: TextStyle(fontWeight: FontWeight.w500,color: Colors.white, fontSize: 13)),
...
class CallLinkErrorViewStyle{
  ...
  const CallLinkErrorViewStyle(
      {this.logoWidget,
      this.callIcon,
      this.callEndedTextStyle = const TextStyle(fontWeight: FontWeight.w500,color: Colors.white, fontSize: 15),
      this.callEndedMessageTextStyle = const TextStyle(fontWeight: FontWeight.w500,color: Colors.white, fontSize: 13),
