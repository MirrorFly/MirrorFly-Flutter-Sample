...
class AppStyleConfig {
  static final ButtonStyle _defaultButtonStyle = ButtonStyle(
      ...
      padding: WidgetStateProperty.resolveWith(
          (states) => const EdgeInsets.symmetric(horizontal: 40, vertical: 10)),
      backgroundColor:
      ...
      textStyle:
        ...
        return const TextStyle(
            fontSize: 14, fontWeight: FontWeight.w500); // Default text style
      }));
  ...
  static final ButtonStyle _defaultDialogButtonStyle = ButtonStyle(
    ...
    return const TextStyle(
        ...
        fontWeight: FontWeight.w600); // Default text style
  }));
  ...
  static final ButtonStyle _disconnectButtonStyle = ButtonStyle(
      ...
      iconColor:
        ...
        if (states.contains(WidgetState.disabled)) {
          return Colors.grey
              .withOpacity(0.5); // Color when the icon is disabled
        }
        return Colors.white; // Default color
      }),
      maximumSize: WidgetStateProperty.resolveWith<Size>(
          (Set<WidgetState> states) => const Size(200, 50)));
  ...
  static final ButtonStyle _joinCallButtonStyle = ButtonStyle(
      ...
      textStyle:
          WidgetStateProperty.resolveWith<TextStyle>((Set<WidgetState> states) {
        return const TextStyle(
            fontSize: 14, fontWeight: FontWeight.w600); // Default text style
      }));
  ...
  static final CallLinkErrorViewStyle callLinkErrorViewStyle =
      CallLinkErrorViewStyle(
          logoWidget: AppUtils.svgIcon(icon: icJoinCallMirrorflyLogo),
          callIcon: CircleAvatar(
            backgroundColor: Colors.white.withOpacity(0.3),
            radius: 33,
            child: AppUtils.svgIcon(icon: icJoinCallEnded),
          ),
          callEndedTextStyle: const TextStyle(
              fontWeight: FontWeight.w500, color: Colors.white, fontSize: 15),
          callEndedMessageTextStyle: const TextStyle(
              fontWeight: FontWeight.w500, color: Colors.white, fontSize: 13),
          returnToChatButtonStyle: _defaultButtonStyle);

  static LoginPageStyle _loginPageStyle =
      LoginPageStyle(loginButtonStyle: _defaultButtonStyle);
  static ProfileViewStyle _profileViewStyle =
      ProfileViewStyle(buttonStyle: _defaultButtonStyle);
  static DashBoardPageStyle _dashBoardPageStyle = DashBoardPageStyle(
      meetBottomSheetStyle:
          MeetBottomSheetStyle(joinMeetingButtonStyle: _joinMeetButtonStyle));
  static ArchivedChatsPageStyle _archivedChatsPageStyle =
      const ArchivedChatsPageStyle();
  static ChatPageStyle _chatPageStyle = ChatPageStyle(
      instantScheduleMeetStyle: InstantScheduleMeetStyle(
          meetBottomSheetStyle: MeetBottomSheetStyle(
              joinMeetingButtonStyle: _joinMeetButtonStyle)));
  static CreateGroupPageStyle _createGroupPageStyle =
      const CreateGroupPageStyle();
  static ChatInfoPageStyle _chatInfoPageStyle = const ChatInfoPageStyle();
  static GroupChatInfoPageStyle _groupChatInfoPageStyle =
      const GroupChatInfoPageStyle();
  static ContactListPageStyle _contactListPageStyle =
      const ContactListPageStyle();
  static SettingsPageStyle _settingsPageStyle = const SettingsPageStyle();
  static ViewAllMediaPageStyle _viewAllMediaPageStyle =
      const ViewAllMediaPageStyle();
  static MessageInfoPageStyle _messageInfoPageStyle =
      const MessageInfoPageStyle();
  static BlockedListPageStyle _blockedListPageStyle =
      const BlockedListPageStyle();
  static StarredMessageListPageStyle _starredMessageListPageStyle =
      const StarredMessageListPageStyle();
  static OutgoingCallPageStyle _outgoingCallPageStyle =
      OutgoingCallPageStyle(disconnectButtonStyle: _disconnectButtonStyle);
  static CallAgainPageStyle _callAgainPageStyle = const CallAgainPageStyle();
  static OngoingCallPageStyle _ongoingCallPageStyle =
      OngoingCallPageStyle(disconnectButtonStyle: _disconnectButtonStyle);
  static CallInfoPageStyle _callInfoPageStyle = const CallInfoPageStyle();
  static AddParticipantsPageStyle _addParticipantsPageStyle =
      const AddParticipantsPageStyle();
  static DialogStyle _dialogStyle =
      DialogStyle(buttonStyle: _defaultDialogButtonStyle);
  static GalleryPageStyle _galleryPageStyle = const GalleryPageStyle();
  static LocalContactPageStyle _localContactPageStyle =
      const LocalContactPageStyle();
  static LocalContactPreviewPageStyle _localContactPreviewPageStyle =
      const LocalContactPreviewPageStyle();
  static LocationSentPageStyle _locationSentPageStyle =
      const LocationSentPageStyle();
  static MediaSentPreviewPageStyle _mediaSentPreviewPageStyle =
      const MediaSentPreviewPageStyle();
  static JoinCallPreviewPageStyle _joinCallPreviewPageStyle =
      JoinCallPreviewPageStyle(
          joinCallButtonStyle: _joinCallButtonStyle,
          callLinkErrorViewStyle: callLinkErrorViewStyle);
  ...
  static ArchivedChatsPageStyle archivedChatsPageStyle =
      _archivedChatsPageStyle;
  ...
  static GroupChatInfoPageStyle groupChatInfoPageStyle =
      _groupChatInfoPageStyle;
  ...
  static StarredMessageListPageStyle starredMessageListPageStyle =
      _starredMessageListPageStyle;
  ...
  static AddParticipantsPageStyle addParticipantsPageStyle =
      _addParticipantsPageStyle;
  ...
  static LocalContactPreviewPageStyle localContactPreviewPageStyle =
      _localContactPreviewPageStyle;
  static LocationSentPageStyle locationSentPageStyle = _locationSentPageStyle;
  static MediaSentPreviewPageStyle mediaSentPreviewPageStyle =
      _mediaSentPreviewPageStyle;
  static JoinCallPreviewPageStyle joinCallPreviewPageStyle =
      _joinCallPreviewPageStyle;
  ...
  static setAppStyle({required AppStyle appStyle}) {
    ...
    archivedChatsPageStyle =
        appStyle.archivedChatsPageStyle ?? _archivedChatsPageStyle;
    chatPageStyle = appStyle.chatPageStyle ?? _chatPageStyle;
    createGroupPageStyle =
        appStyle.createGroupPageStyle ?? _createGroupPageStyle;
    chatInfoPageStyle = appStyle.chatInfoPageStyle ?? _chatInfoPageStyle;
    groupChatInfoPageStyle =
        appStyle.groupChatInfoPageStyle ?? _groupChatInfoPageStyle;
    contactListPageStyle =
        appStyle.contactListPageStyle ?? _contactListPageStyle;
    settingsPageStyle = appStyle.settingsPageStyle ?? _settingsPageStyle;
    viewAllMediaPageStyle =
        appStyle.viewAllMediaPageStyle ?? _viewAllMediaPageStyle;
    messageInfoPageStyle =
        appStyle.messageInfoPageStyle ?? _messageInfoPageStyle;
    blockedListPageStyle =
        appStyle.blockedListPageStyle ?? _blockedListPageStyle;
    starredMessageListPageStyle =
        appStyle.starredMessageListPageStyle ?? _starredMessageListPageStyle;
    outgoingCallPageStyle =
        appStyle.outgoingCallPageStyle ?? _outgoingCallPageStyle;
    callAgainPageStyle = appStyle.callAgainPageStyle ?? _callAgainPageStyle;
    ongoingCallPageStyle =
        appStyle.ongoingCallPageStyle ?? _ongoingCallPageStyle;
    addParticipantsPageStyle =
        appStyle.addParticipantsPageStyle ?? _addParticipantsPageStyle;
  ...
  static setGroupChatInfoPageStyle(
  ...
  static setStarredMessageListPageStyle(
  ...
  static setLocalContactPreviewPageStyle(
      LocalContactPreviewPageStyle localContactPreviewPageStyle) {
  ...
  static setMediaSentPreviewPageStyle(
      MediaSentPreviewPageStyle mediaSentPreviewPageStyle) {
    _mediaSentPreviewPageStyle = mediaSentPreviewPageStyle;
  }

  static setJoinCallPreviewPageStyle(
      JoinCallPreviewPageStyle joinCallPreviewPageStyle) {
