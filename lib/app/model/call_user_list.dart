...
List<CallUserList> callUserListFromJson(String str) => List<CallUserList>.from(
    json.decode(str).map((x) => CallUserList.fromJson(x)));

String callUserListToJson(List<CallUserList> data) =>
...
class CallUserList {
  ...
  CallUserList({
    ...
    required bool isVideoMuted,
        ...
        isVideoMuted = RxBool(isVideoMuted);
