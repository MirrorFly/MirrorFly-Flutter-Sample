...
class AppPermission {
  ...
  static Future<bool> askAudioCallPermissions() async {
    ...
    if ((speech != PermissionStatus.granted &&
            speech != PermissionStatus.permanentlyDenied) ||
        (phone != PermissionStatus.granted &&
            phone != PermissionStatus.permanentlyDenied) ||
      ...
      if (deniedPopupValue) {
        ...
        if (speech_!.isGranted &&
            phone_!.isGranted &&
            bluetoothConnect_!.isGranted) {
          return true;
        } else if (speech_.isPermanentlyDenied ||
            phone_!.isPermanentlyDenied ||
