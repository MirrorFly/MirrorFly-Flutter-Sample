...
class MessageInfoView extends NavViewStateful<MessageInfoController> {
  ...
  @override
  MessageInfoController createController({String? tag}) =>
  ...
  Widget build(BuildContext context) {
    return Theme(
      data: Theme.of(context).copyWith(
          appBarTheme: AppStyleConfig.messageInfoPageStyle.appBarTheme),
      child: Scaffold(
          appBar: appbar ??
              AppBar(
                          ...
                          return Column(
                            children: [
                              ...
                              MessageContent(
                                ...
                                onPlayAudio: () {
                                  controller
                                      .playAudio(controller.chatMessage[0]);
                                },
                                ...
                                senderChatBubbleStyle: AppStyleConfig
                                    .messageInfoPageStyle.senderChatBubbleStyle,
                              )
  ...
  Widget statusView(BuildContext context) {
    return controller.isGroupProfile
        ? Obx(() {
            return Column(
                            ...
                            itemBuilder: (cxt, index) {
                              ...
                              return MemberItem(
                                ...
                                itemStyle: AppStyleConfig
                                    .messageInfoPageStyle.deliveredItemStyle,
                              );
                            })
                        : emptyDeliveredSeen(
                            context,
                            ...
                            AppStyleConfig
                                .messageInfoPageStyle.deliveredMsgTitleStyle)),
                const AppDivider(),
                ListItem(
                              ...
                              return MemberItem(
                                ...
                                unknown:
                                    (!member.isItSavedContact.checkNull() ||
                                        member.isDeletedContact()),
                                itemStyle: AppStyleConfig
                                    .messageInfoPageStyle.readItemStyle,
                              );
                            })
                        : emptyDeliveredSeen(
                            context,
                            ...
                            AppStyleConfig
                                .messageInfoPageStyle.readMsgTitleStyle)),
                const AppDivider(),
              ],
            );
          })
