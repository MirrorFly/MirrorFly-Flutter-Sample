        ...
        children: [
          ...
          Text(
            Helper.durationToString(Duration(
                microseconds: mediaChatMessage != null
...
class AudioMessageView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    var currentPos =
        double.parse(chatMessage.mediaChatMessage!.currentPos.toString());
    var maxPos =
                  ...
                  children: [
                    ...
                    Text(
                      Helper.durationToString(
                          Duration(microseconds: mediaMessage.mediaDuration)),
