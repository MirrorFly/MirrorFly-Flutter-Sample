...
class ContactListView extends NavViewStateful<ContactController> {
  ...
  @override
  ContactController createController({String? tag}) =>
            ...
            appBar: AppBar(
              ...
              title: controller.search
                  ? TextField(
                      ...
                      style: AppStyleConfig.contactListPageStyle
                      ...
                      decoration: InputDecoration(
                          ...
                          hintStyle: AppStyleConfig.contactListPageStyle
                  ...
                  : arg.forGroup
                      ? Text(
                          ...
                          style: AppStyleConfig
                              .contactListPageStyle.appBarTheme.titleTextStyle,
                        )
                      : Text(
                          getTranslated("contacts"),
                          style: AppStyleConfig
                              .contactListPageStyle.appBarTheme.titleTextStyle,
                        ),
              actions: [
                ...
                Visibility(
                  ...
                  child: TextButton(
                      ...
                      child: Text(
                        (arg.groupJid.isNotEmpty
                                ? getTranslated("next")
                                : getTranslated("create"))
                            .toUpperCase(),
                        style:
                            AppStyleConfig.contactListPageStyle.actionTextStyle,
                ...
                Visibility(
                  ...
                  child: CustomActionBarIcons(
                    ...
                    actionWidth: 48,
                    popupMenuThemeData:
                        AppStyleConfig.contactListPageStyle.popupMenuThemeData,
                    actions: [
                      CustomAction(
                        ...
                        showAsAction: (Constants.enableContactSync &&
                                !controller.progressSpinner.value)
                            ? ShowAsAction.never
                            : ShowAsAction.gone,
                        keyValue: 'Refresh',
                        onItemClick: () {
                    ...
                    children: [
                          ...
                          child: Center(
                            child: Padding(
                              ...
                              child: Text(
                                ...
                                style: AppStyleConfig
                                    .contactListPageStyle.noDataTextStyle,
                              ),
                            ),
                          )),
                      ...
                      Column(
                        children: [
                                      ...
                                      itemBuilder:
                                        ...
                                        if (index >=
                                          ...
                                          return ContactItem(
                                            ...
                                            onAvatarClick: () {
                                              controller
                                                  .showProfilePopup(item.obs);
                                            },
                                            spanTxt:
                                                controller.searchQuery.text,
                                            isCheckBoxVisible:
                                                arg.forMakeCall || arg.forGroup,
                          ...
                          Obx(() {
                            return controller.groupCallMembersCount.value > 1
                                ? InkWell(
                                    onTap: () {
                                      controller.makeCall();
                                    },
                                            ...
                                            children: [
                                              ...
                                              Text(
                                                getTranslated(
                                                    ...
                                                    .replaceAll(
                                                        "%d",
                                                        (controller.groupCallMembersCount
                                                                    .value -
                                                                1)
                                                            .toString()),
