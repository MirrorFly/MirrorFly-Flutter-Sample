...
class EditMessageScreen extends StatefulWidget {
  ...
  const EditMessageScreen(
      {super.key, required this.chatController, required this.chatItem});
                      ...
                      Align(
                        ...
                        child: Container(
                          ...
                          decoration: BoxDecoration(
                              ...
                              color: (widget.chatItem.isMessageSentByMe
                                  ? chatSentBgColor
                                  : Colors.white),
                              border: widget.chatItem.isMessageSentByMe
                                  ? Border.all(color: chatSentBgColor)
                                  : Border.all(color: chatBorderColor)),
                          child: Column(
                            crossAxisAlignment: CrossAxisAlignment.start,
                            children: [
                              if (widget.chatController.profile.isGroupProfile
                                  .checkNull()) ...[
                                SenderHeader(
                                  isGroupProfile: widget
                                      .chatController.profile.isGroupProfile,
                                  chatList: [widget.chatItem],
                                  index: 0,
                                  textStyle: null,
                                ),
                              ],
                              widget.chatItem.isThisAReplyMessage
                                  ? widget.chatItem.replyParentChatMessage ==
                                          null
                                      ? messageNotAvailableWidget(
                                          widget.chatItem)
                                      : ReplyMessageHeader(
                                          chatMessage: widget.chatItem)
                ...
                child: /*ChatInputField(
                  ...
                  child: Column(
                    children: [
                      ...
                      IntrinsicHeight(
                        child: Row(
                          ...
                          children: [
                            ...
                            Obx(() {
                              return widget.chatController.editMessageText.value
                                              .trim() !=
                                          messageToEdit &&
                                      widget
                                          .chatController.editMessageText.value
                                          .trim()
                                          .isNotEmpty
                                  ? InkWell(
                                      onTap: () {
                                        widget.chatController.updateSentMessage(
                      ...
                      widget.chatController.emojiLayout(
