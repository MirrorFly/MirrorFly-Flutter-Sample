        ...
        if(controller.isAudioRecording.value ==
          ...
          IconButton(onPressed: () {
            ...
            color: AppStyleConfig.chatPageStyle.messageTypingAreaStyle
              ...
              : SvgPicture.asset(smileIcon, colorFilter: ColorFilter.mode(
              AppStyleConfig.chatPageStyle.messageTypingAreaStyle
                  .emojiIconColor, BlendMode.srcIn),))
        ],
      ...
      return [
        CustomAction(
          visibleWidget: IconButton(
            ...
            icon: SvgPicture.asset(replyIcon, colorFilter: ColorFilter.mode(
        ...
        CustomAction(
          visibleWidget: IconButton(
            ...
            icon: SvgPicture.asset(forwardIcon, colorFilter: ColorFilter.mode(
                AppStyleConfig.chatPageStyle.appBarTheme.actionsIconTheme
                    ?.color ?? Colors.black, BlendMode.srcIn)),
            tooltip: 'Forward',
          ),
        ...
        CustomAction(
          visibleWidget: IconButton(
            ...
            icon: SvgPicture.asset(favouriteIcon, colorFilter: ColorFilter.mode(
                AppStyleConfig.chatPageStyle.appBarTheme.actionsIconTheme
                    ?.color ?? Colors.black, BlendMode.srcIn)),
            tooltip: 'Favourite',
          ),
        ...
        CustomAction(
          visibleWidget: IconButton(
            ...
            icon: SvgPicture.asset(deleteIcon, colorFilter: ColorFilter.mode(
                AppStyleConfig.chatPageStyle.appBarTheme.actionsIconTheme
                    ?.color ?? Colors.black, BlendMode.srcIn)),
            tooltip: 'Delete',
          ),
        ...
        CustomAction(
          visibleWidget: IconButton(
            onPressed: () {},
            icon: SvgPicture.asset(shareIcon, colorFilter: ColorFilter.mode(
                AppStyleConfig.chatPageStyle.appBarTheme.actionsIconTheme
                    ?.color ?? Colors.black, BlendMode.srcIn)),
            tooltip: 'Share',
          ),
          ...
          actions: [
                ...
                icon: SvgPicture.asset(videoCallIcon,
                    colorFilter: ColorFilter.mode(
                        AppStyleConfig.chatPageStyle.appBarTheme
                            .actionsIconTheme?.color ?? Colors.black,
                        BlendMode.srcIn)),
              ),
              overflowWidget: Text(getTranslated("videoCall"),
                  style: AppStyleConfig.chatPageStyle.popupMenuThemeData
                      .textStyle),
              showAsAction: controller.isVideoCallAvailable ? ShowAsAction
                  .always : ShowAsAction.gone,
              keyValue: 'Video Call',
            ...
            CustomAction(
              ...
              overflowWidget: Text(getTranslated("audioCall"),
                  style: AppStyleConfig.chatPageStyle.popupMenuThemeData
                      .textStyle),
              showAsAction: controller.isAudioCallAvailable ? ShowAsAction
                  .always : ShowAsAction.gone,
              keyValue: 'Audio Call',
              onItemClick: controller.ableToCall ? () {
                controller.makeVoiceCall();
